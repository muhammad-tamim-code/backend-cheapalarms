...
$faq_items = site_blocks_get_intercom_faq_items();
?>
<section class="sg-value-row sg-value-row--peach sg-cctv-faq sg-intercom-faq alignfull" aria-labelledby="sg-intercom-faq-heading">
	<div class="sg-container sg-value-row__grid">
		<div class="sg-value-row__copy">
			<h2 class="sg-value-row__title" id="sg-intercom-faq-heading">
			...
			<div class="sg-value-faq">
				<div class="sg-value-faq__column">
					...
					foreach ( array_slice( $faq_items, 0, 3 ) as $faq_index => $faq_item ) {
						site_blocks_render_value_faq_item( $faq_item, $faq_index + 1, 'sg-intercom-faq-' );
					}
					?>
				</div>
				<div class="sg-value-faq__column">
					...
					foreach ( array_slice( $faq_items, 3 ) as $faq_index => $faq_item ) {
						site_blocks_render_value_faq_item( $faq_item, $faq_index + 4, 'sg-intercom-faq-' );
					}
					?>
				</div>
			</div>
