...
return array(
	...
	'content'     => '<div class="sg-page alignfull"><!-- wp:site/safeguard-header /--><main id="main" class="sg-main"><!-- wp:site/cctv-hero /--><!-- wp:site/cctv-intro /--><!-- wp:site/cctv-spotlight /--><!-- wp:site/cctv-difference /--><!-- wp:site/cctv-install /--><!-- wp:site/cctv-photo-band /--><!-- wp:site/cctv-segments /--><!-- wp:site/cctv-layered /--><!-- wp:site/cctv-portal /--><!-- wp:site/cctv-trust /--><!-- wp:site/cctv-faq /--><!-- wp:site/cctv-related /--><!-- wp:site/cctv-quote-cta /--></main><!-- wp:site/safeguard-footer /--></div>',
);
