...
return array(
	'title'       => __( 'Mobile Patrols Page', 'site-blocks' ),
	'description' => __( 'Mobile patrol service page under Physical Security.', 'site-blocks' ),
	'categories'  => array( 'site-pages' ),
	'keywords'    => array( 'mobile patrols', 'physical security', 'safeguard' ),
